...
CREATE TABLE vehicles (
    ...
    headquarters ENUM('Sede Central - San Pablo, Heredia', 'Sede Secundaria - San Joaquín, Heredia') NOT NULL -- Sede donde se encuentra el vehículo
);
